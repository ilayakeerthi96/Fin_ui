...
function MessageDialogComponent_ng_container_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "button", 7);
    \u0275\u0275listener("click", function MessageDialogComponent_ng_container_9_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function MessageDialogComponent_ng_container_9_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function MessageDialogComponent_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 7);
    \u0275\u0275listener("click", function MessageDialogComponent_ng_template_10_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
var _MessageDialogComponent = class _MessageDialogComponent {
...
_MessageDialogComponent.\u0275fac = function MessageDialogComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MessageDialogComponent)(\u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(MAT_DIALOG_DATA));
};
_MessageDialogComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MessageDialogComponent, selectors: [["app-message-dialog"]], decls: 12, vars: 6, consts: [["okOnly", ""], [1, "dialog-container"], [1, "dialog-icon", 3, "ngClass"], [1, "dialog-title"], [1, "dialog-message"], ["align", "center"], [4, "ngIf", "ngIfElse"], [1, "btn", "btn-primary", 3, "click"]], template: function MessageDialogComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "mat-dialog-content", 4)(6, "p");
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "mat-dialog-actions", 5);
    \u0275\u0275template(9, MessageDialogComponent_ng_container_9_Template, 6, 0, "ng-container", 6)(10, MessageDialogComponent_ng_template_10_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const okOnly_r4 = \u0275\u0275reference(11);
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", ctx.data.type);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx.iconMap[ctx.data.type]);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx.data.title);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx.data.message);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx.data.showConfirmButtons)("ngIfElse", okOnly_r4);
  }
}, dependencies: [MatIconModule, MatIcon, MatDialogModule, MatDialogActions, MatDialogContent, CommonModule, NgClass, NgIf], styles: ["\n\n.dialog-container[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n  padding: 20px;\n}\n.dialog-icon[_ngcontent-%COMP%] {\n  font-size: 50px;\n  margin-bottom: 10px;\n}\n.success[_ngcontent-%COMP%] {\n  color: #4CAF50;\n}\n.error[_ngcontent-%COMP%] {\n  color: #F44336;\n}\n.warning[_ngcontent-%COMP%] {\n  color: #FFC107;\n}\n.info[_ngcontent-%COMP%] {\n  color: #2196F3;\n}\n.dialog-title[_ngcontent-%COMP%] {\n  font-size: 20px;\n  font-weight: bold;\n  margin-bottom: 10px;\n}\n.dialog-message[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  font-size: 16px;\n  margin: 10px 0;\n}\n.dialog-button[_ngcontent-%COMP%] {\n  background-color: #1976D2;\n  color: white;\n  font-weight: bold;\n  padding: 8px 16px;\n  border-radius: 4px;\n}\n.dialog-button[_ngcontent-%COMP%]:hover {\n  background-color: #1565C0;\n}\n/*# sourceMappingURL=message-dialog.component.css.map */"] });
var MessageDialogComponent = _MessageDialogComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MessageDialogComponent, [{
    type: Component,
    args: [{ selector: "app-message-dialog", standalone: true, imports: [MatIconModule, MatDialogModule, CommonModule], template: '<div class="dialog-container">\r\n  <!-- Icon -->\r\n  <mat-icon class="dialog-icon" [ngClass]="data.type">{{ iconMap[data.type] }}</mat-icon>\r\n\r\n  <!-- Title -->\r\n  <h2 class="dialog-title">{{ data.title }}</h2>\r\n\r\n  <!-- Message -->\r\n  <mat-dialog-content class="dialog-message">\r\n    <p>{{ data.message }}</p>\r\n  </mat-dialog-content>\r\n\r\n  <!-- Actions -->\r\n  <mat-dialog-actions align="center">\r\n    <ng-container *ngIf="data.showConfirmButtons; else okOnly">\r\n      <button class="btn btn-primary" (click)="onCancel()">Cancel</button> &nbsp;&nbsp;&nbsp;\r\n      <button class="btn btn-primary" (click)="onConfirm()">Confirm</button>\r\n    </ng-container>\r\n\r\n    <ng-template #okOnly>\r\n    <button class="btn btn-primary" (click)="closeDialog()">OK</button>\r\n    </ng-template>\r\n  </mat-dialog-actions>\r\n</div>\r\n', styles: ["/* src/app/shared/message-dialog/message-dialog.component.css */\n.dialog-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  text-align: center;\n  padding: 20px;\n}\n.dialog-icon {\n  font-size: 50px;\n  margin-bottom: 10px;\n}\n.success {\n  color: #4CAF50;\n}\n.error {\n  color: #F44336;\n}\n.warning {\n  color: #FFC107;\n}\n.info {\n  color: #2196F3;\n}\n.dialog-title {\n  font-size: 20px;\n  font-weight: bold;\n  margin-bottom: 10px;\n}\n.dialog-message p {\n  font-size: 16px;\n  margin: 10px 0;\n}\n.dialog-button {\n  background-color: #1976D2;\n  color: white;\n  font-weight: bold;\n  padding: 8px 16px;\n  border-radius: 4px;\n}\n.dialog-button:hover {\n  background-color: #1565C0;\n}\n/*# sourceMappingURL=message-dialog.component.css.map */\n"] }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MessageDialogComponent, { className: "MessageDialogComponent", filePath: "src/app/shared/message-dialog/message-dialog.component.ts", lineNumber: 14 });
})();
...
var _MessageService = class _MessageService {
  ...
  showMessage(type, title, message, redirectUrl) {
...
_MessageService.\u0275fac = function MessageService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MessageService)(\u0275\u0275inject(MatDialog), \u0275\u0275inject(Router));
};
...
(() => {
  ...
  }], () => [{ type: MatDialog }, { type: Router }], null);
})();
...
//# sourceMappingURL=chunk-4TRDTO5Y.js.map
